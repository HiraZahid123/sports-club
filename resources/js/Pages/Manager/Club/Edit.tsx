...
export default function ClubEdit({ club, facilities, join_link, status }: { club: Club; facilities: Facility[]; join_link?: string | null; status?: string }) {
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 px-6 py-5 border-b border-emerald-100 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-base font-bold text-emerald-900">Facilities Setup</h3>
                        ...
                        {facilities.map(facility => (
                            <div key={facility.id}>
                                {editingId === facility.id ? (
                                    ...
                                    <div className="flex items-center justify-between bg-slate-50 hover:bg-slate-100/50 rounded-xl px-4 py-3 border border-gray-100 transition-all">
                                        <div>
