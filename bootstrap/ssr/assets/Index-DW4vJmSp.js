...
function EventsIndex({ events, groups, coaches, categories = [] }) {
  ...
  const renderForm = (form, onSubmit, fileRef, editing) => {
    ...
    return /* @__PURE__ */ jsxs("form", { onSubmit, className: "p-6 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5", children: "Event Category" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              ...
              className: inputClass,
              children: [
                /* @__PURE__ */ jsx("option", { value: "", children: "Custom / Manual Points" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5", children: "Event Poster / Picture (optional)" }),
          editing?.image_url && form.data.remove_image !== "1" && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2 p-3 bg-amber-50 border border-amber-100 rounded-xl", children: [
            /* @__PURE__ */ jsx("img", { src: editing.image_url, alt: "Event poster", className: "w-10 h-10 object-cover rounded-lg border border-amber-200 shrink-0" }),
            /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-amber-700", children: "Current Poster attached" }),
            /* @__PURE__ */ jsx("button", { type: "button", onClick: () => form.setData({ ...form.data, remove_image: "1" }), className: "ml-auto text-xs text-red-500 hover:text-red-700 font-semibold", children: "Remove" })
          ] }),
          /* @__PURE__ */ jsx(
            "input",
            {
          ...
          form.errors.image && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-red-600", children: form.errors.image })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-2", children: "Group Access Permissions *" }),
        groups.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 italic", children: "No groups yet — create groups first." }) : /* @__PURE__ */ jsx("div", { className: "space-y-3 bg-slate-50 p-4 rounded-xl border border-slate-100", children: groups.map((g) => {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-white px-4 py-2.5 rounded-lg border border-slate-100 hover:border-indigo-100 transition-colors", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-gray-800", children: g.name }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6", children: [
              /* @__PURE__ */ jsxs("label", { className: "inline-flex items-center gap-1.5 cursor-pointer", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-gray-500", children: "Visible" })
              ] }),
              /* @__PURE__ */ jsxs("label", { className: `inline-flex items-center gap-1.5 ${isVisible ? "cursor-pointer" : "opacity-40 cursor-not-allowed"}`, children: [
                /* @__PURE__ */ jsx(
                  "input",
                  {
                    type: "checkbox",
                ...
                /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-gray-500", children: "Can Join" })
              ] })
            ] })
          ] }, g.id);
        }) }),
          ...
          events.length === 0 && !isCreating ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm py-16 text-center", children: [
            ...
            return /* @__PURE__ */ jsxs("div", { className: `bg-white rounded-2xl border shadow-sm hover:shadow-md transition-shadow flex flex-col overflow-hidden ${isEdit ? "border-amber-300 ring-2 ring-amber-200" : "border-gray-100"}`, children: [
              ev.image_url ? /* @__PURE__ */ jsxs("div", { className: "relative aspect-[16/9] w-full overflow-hidden bg-slate-100 border-b border-gray-50", children: [
                ...
                isEdit && /* @__PURE__ */ jsx("span", { className: "absolute top-3 right-3 bg-amber-500/90 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg", children: "✏️ Editing" })
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
                  ...
                  isEdit && /* @__PURE__ */ jsx("span", { className: "bg-amber-500/90 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg", children: "✏️ Editing" })
                ] }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-5 flex-1 space-y-3", children: [
                ...
                ev.coaches.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1", children: ev.coaches.map((c) => /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 pl-1 pr-2 py-0.5 bg-emerald-50 border border-emerald-100 text-emerald-700 text-[10px] font-semibold rounded-md", children: [
                    /* @__PURE__ */ jsx(
                      UserAvatar,
                      {
                        name: c.name,
