      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-3xl border border-gray-150 shadow-sm overflow-hidden", children: [
            ...
            filteredLeaderboard.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center py-16 text-gray-400 italic text-sm", children: "No athletes found matching your search." }) : /* @__PURE__ */ jsx("div", { className: "divide-y divide-gray-50", children: filteredLeaderboard.map((ath, index) => {
              const rank = index + 1;
