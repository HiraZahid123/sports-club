  ...
  const renderEvent = (ev) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col overflow-hidden", children: [
      ev.image_url ? /* @__PURE__ */ jsxs("div", { className: "relative aspect-[16/9] w-full overflow-hidden bg-slate-100 border-b border-gray-50", children: [
        ...
        !ev.can_join_event && /* @__PURE__ */ jsx("span", { className: "absolute top-3 right-3 bg-slate-900/80 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg", children: "👁️ View Only" })
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
          ...
          !ev.can_join_event && /* @__PURE__ */ jsx("span", { className: "bg-slate-900/85 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg", children: "👁️ View Only" })
        ] }),
      ...
      ] }) : !ev.can_join_event ? /* @__PURE__ */ jsx("div", { className: "text-center py-2 bg-gray-100 text-gray-500 border border-gray-200/50 text-xs font-semibold rounded-xl select-none", children: "👁️ View Only — Group Restricted" }) : ev.is_free ? /* @__PURE__ */ jsx(
        "button",
        {
