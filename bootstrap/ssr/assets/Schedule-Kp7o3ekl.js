          ...
          /* @__PURE__ */ jsx("div", { className: "mt-8 overflow-hidden rounded-xl border border-gray-100", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-gray-200 text-left", children: schedules.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 5, className: "px-6 py-8 text-center text-sm text-gray-500", children: "No scheduled training sessions." }) }) : schedules.map((slot) => {
              ...
              return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50 transition-colors", children: [
                /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900", children: slot.group ? /* @__PURE__ */ jsxs(
                  Link,
                  {
                    href: markAttendanceUrl,
                    className: "text-indigo-600 hover:text-indigo-900 hover:underline inline-flex items-center gap-2",
                    children: [
                      /* @__PURE__ */ jsx("span", { children: slot.day_of_week }),
                      /* @__PURE__ */ jsx("span", { className: "bg-indigo-50 text-indigo-700 text-[11px] font-black px-1.5 py-0.5 rounded border border-indigo-100", children: dateNum })
                    ]
                  }
                ) : /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx("span", { children: slot.day_of_week }),
                  /* @__PURE__ */ jsx("span", { className: "bg-gray-50 text-gray-600 text-[11px] font-black px-1.5 py-0.5 rounded border border-gray-100", children: dateNum })
                ] }) }),
