  ...
  const statCards = [
    {
      ...
      changeType: totalMembersChange >= 0 ? "increase" : "decrease",
    ...
    },
    {
      ...
      changeType: activeGroupsChange >= 0 ? "increase" : "decrease",
    ...
    },
    {
      ...
      changeType: monthlyNetRevenueChange >= 0 ? "increase" : "decrease",
    ...
    },
    {
      ...
      changeType: overdueChange <= 0 ? "increase" : "decrease",
