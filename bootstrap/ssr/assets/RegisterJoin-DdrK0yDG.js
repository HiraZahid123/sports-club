...
function RegisterJoin({ club: initialClub, prefill_code }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex lg:w-5/12 bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 flex-col justify-between p-12 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(Link, { href: "/", children: /* @__PURE__ */ jsx("img", { src: mlSportsLogo, alt: "ML Sports", className: "h-16 w-auto object-contain brightness-0 invert" }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col items-center justify-center px-6 py-12 bg-white overflow-y-auto", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:hidden flex items-center mb-8", children: /* @__PURE__ */ jsx(Link, { href: "/", children: /* @__PURE__ */ jsx("img", { src: mlSportsLogo, alt: "ML Sports", className: "h-14 w-auto object-contain" }) }) }),
      /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md", children: [
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-5", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-slate-50 rounded-2xl border border-gray-100 p-5 space-y-4", children: [
            ...
            data.role === "Athlete" && resolvedClub && /* @__PURE__ */ jsxs("div", { className: "bg-yellow-50/50 border border-yellow-100 rounded-xl p-4 space-y-4", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-yellow-800", children: "Step 4 — Choose Training Group & Subscription" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsxs("label", { className: labelClass, children: [
                  "Training Group ",
                  /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                ...
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    required: true,
                    children: [
                      /* @__PURE__ */ jsx("option", { value: "", children: "Select Training Group" }),
                      availableGroups.map((g) => /* @__PURE__ */ jsx("option", { value: g.id, children: g.name }, g.id))
                    ]
                  }
                ),
                /* @__PURE__ */ jsx(InputError, { message: errors.training_group_id, className: "mt-2" })
              ] }),
              data.training_group_id && /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("label", { className: labelClass, children: [
                    "Subscription Plan ",
                    /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                  ...
                  /* @__PURE__ */ jsxs(
                    "select",
                    {
                      ...
                      required: true,
                      children: [
                        /* @__PURE__ */ jsx("option", { value: "", children: "Select Subscription Plan" }),
                        filteredPlans.map((p) => {
                ...
                data.subscription_plan_id && /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsxs("label", { className: labelClass, children: [
                    "Billing Cycle ",
                    /* @__PURE__ */ jsx("span", { className: "text-red-500", children: "*" })
                  ] }),
                  /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-3", children: ["monthly", "yearly"].map((cycle) => {
                    ...
                    return /* @__PURE__ */ jsxs(
                      "button",
                      {
                        ...
                        className: `py-3 px-4 rounded-xl border-2 text-sm font-bold capitalize transition-all ${data.billing_cycle === cycle ? "border-emerald-500 bg-emerald-50 text-emerald-700" : "border-gray-200 bg-white text-gray-600 hover:border-gray-300"}`,
                        children: [
                          cycle,
                          " (€",
