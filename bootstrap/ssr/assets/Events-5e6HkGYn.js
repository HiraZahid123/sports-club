...
function CoachEvents({ events }) {
  ...
  const renderEventCard = (ev) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col overflow-hidden", children: [
      ev.image_url ? /* @__PURE__ */ jsxs("div", { className: "relative aspect-[16/9] w-full overflow-hidden bg-slate-100 border-b border-gray-50", children: [
        /* @__PURE__ */ jsx("img", { src: ev.image_url, alt: ev.name, className: "w-full h-full object-cover transition-transform duration-500 hover:scale-105" }),
        pendingCount > 0 && /* @__PURE__ */ jsxs("span", { className: "absolute top-3 right-3 bg-red-500/90 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg animate-pulse", children: [
          "🔔 ",
          pendingCount,
          " Pending"
        ] })
      ] }) : /* @__PURE__ */ jsxs("div", { className: "relative aspect-[16/9] w-full overflow-hidden bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-700 border-b border-gray-50 flex flex-col justify-between p-4 text-white", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
          /* @__PURE__ */ jsx("span", { className: "bg-white/10 backdrop-blur-md border border-white/20 text-white text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-md", children: "Event" }),
          pendingCount > 0 && /* @__PURE__ */ jsxs("span", { className: "bg-red-500/90 backdrop-blur-md text-white text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-lg animate-pulse", children: [
            "🔔 ",
            pendingCount,
            " Pending"
          ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsx("h4", { className: "font-black text-sm leading-snug drop-shadow-sm line-clamp-2", children: ev.name }),
          /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-white/80 font-medium", children: [
            "🏆 Earn ",
            ev.points,
            " Points"
          ] })
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-5 flex-1 space-y-3", children: [
        ...
        ev.coach_salary_type && ev.coach_salary_type !== "free" && /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-1.5 bg-indigo-50 border border-indigo-100 rounded-xl px-3 py-1.5", children: [
        ...
        ev.groups.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-gray-400 uppercase tracking-wide mb-1", children: "Target Groups" }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1", children: ev.groups.map((g) => /* @__PURE__ */ jsx("span", { className: "px-2 py-0.5 bg-emerald-50 border border-emerald-100 text-emerald-700 text-[10px] font-semibold rounded-md", children: g.name }, g.id)) })
        ] }),
        ev.pdf_url && /* @__PURE__ */ jsxs("a", { href: ev.pdf_url, target: "_blank", rel: "noopener", className: "inline-flex items-center gap-1.5 text-xs text-rose-600 hover:text-rose-800 font-semibold mt-1", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "px-5 py-3.5 bg-slate-50 border-t border-gray-100 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2 text-xs font-semibold text-gray-500", children: [
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8", children: events.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm py-16 text-center", children: [
          ...
          upcoming.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5", children: upcoming.map(renderEventCard) })
          ] }),
          past.length > 0 && /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 opacity-75", children: past.map(renderEventCard) })
          ] })
        ] }) }) }),
        activeEvent && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm transition-opacity duration-300", children: /* @__PURE__ */ jsxs("div", { className: "relative bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[85vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200", children: [
          /* @__PURE__ */ jsxs("div", { className: "px-6 py-5 border-b border-gray-100 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-gray-900", children: activeEvent.name }),
              /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 mt-1", children: [
                fmtDate(activeEvent.start_date),
                " ",
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M6 18L18 6M6 6l12 12" }) })
              }
            )
          ] }),
          /* @__PURE__ */ jsx("div", { className: "p-6 overflow-y-auto flex-1 space-y-4", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsxs("h4", { className: "text-xs font-bold text-gray-400 uppercase tracking-wide mb-3", children: [
              "Registrations (",
              activeEvent.registrations.length,
              ")"
            ] }),
            activeEvent.registrations.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-200", children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 font-semibold", children: "No registrations yet" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-1", children: "Athletes will appear here after registering for this event." })
            ] }) : /* @__PURE__ */ jsx("div", { className: "space-y-2.5", children: activeEvent.registrations.map((reg) => {
              ...
              return /* @__PURE__ */ jsxs(
                "div",
                {
                  className: `flex items-center justify-between rounded-xl px-4 py-3 border.5 transition-all ${reg.status === "attended" ? "bg-emerald-50/50 border-emerald-100" : reg.status === "rejected" ? "bg-red-50/30 border-red-100" : "bg-white border-gray-100 shadow-sm"}`,
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
                      reg.user.profile_photo ? /* @__PURE__ */ jsx(
                        "img",
                        {
                      ...
                      ) : /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-xl bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold text-sm shrink-0", children: reg.user.name.charAt(0).toUpperCase() }),
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 shrink-0 ml-3", children: [
                      /* @__PURE__ */ jsx("span", { className: `px-2.5 py-1 rounded-lg text-xs font-bold ${cfg.bg} ${cfg.text}`, children: cfg.label }),
                      canAct && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
                        /* @__PURE__ */ jsxs(
                          "button",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsx("svg", { className: "w-3.5 h-3.5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M5 13l4 4L19 7" }) }),
                        ...
                        /* @__PURE__ */ jsxs(
                          "button",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsx("svg", { className: "w-3.5 h-3.5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.5, d: "M6 18L18 6M6 6l12 12" }) }),
                              processing === rejKey ? "…" : "Reject"
                            ]
                          }
                        )
                      ] }),
                      reg.status === "attended" && /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold text-indigo-600 bg-indigo-50 border border-indigo-100 px-2 py-0.5 rounded", children: [
                        "+",
                        activeEvent.points,
                        " pts"
                      ] })
          ...
          /* @__PURE__ */ jsx("div", { className: "px-6 py-4 bg-slate-50 border-t border-gray-100 flex justify-end", children: /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => setSelectedEventId(null),
