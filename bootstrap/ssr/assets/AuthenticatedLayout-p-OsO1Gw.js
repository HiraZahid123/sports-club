...
import { m as mlSportsLogo } from "./ml-sports-BsguC5B3.js";
...
function resolvePhotoUrl(photo) {
  ...
  if (value.startsWith("http://") || value.startsWith("https://") || value.startsWith("//") || value.startsWith("blob:") || value.startsWith("data:")) {
    return value;
  }
...
function UserAvatar({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      className: `shrink-0 overflow-hidden flex items-center justify-center font-bold ${showPhoto ? "bg-slate-100" : fallbackClassName} ${className}`,
      children: showPhoto ? /* @__PURE__ */ jsx(
        "img",
        {
          src,
          alt: name ?? "User",
...
function Authenticated({
  ...
  const isClubActive = isManager && (route().current("manager.club.edit") || route().current("manager.members.index") || route().current("manager.coaches.index") || route().current("manager.groups.index") || route().current("manager.attendance.*") || route().current("manager.points.*"));
  const isBillingActive = isManager && (route().current("manager.billing.index") || route().current("manager.reports.index"));
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50", children: [
    /* @__PURE__ */ jsxs("nav", { className: "bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm", children: [
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex h-16 items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 lg:gap-6 min-w-0", children: [
          /* @__PURE__ */ jsx(Link, { href: "/", className: "flex items-center shrink-0", children: /* @__PURE__ */ jsx("img", { src: mlSportsLogo, alt: "ML Sports", className: "h-14 w-auto object-contain" }) }),
          user.club && /* @__PURE__ */ jsx("span", { className: "hidden xl:block text-xs font-semibold text-gray-400 border-l border-gray-200 pl-4 uppercase tracking-widest truncate max-w-32", children: user.club.name }),
          /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex items-center gap-0.5 min-w-0", children: [
            /* @__PURE__ */ jsx(
              NavLink,
              {
                href: route("dashboard"),
                active: route().current("dashboard") || route().current("manager.dashboard") || route().current("coach.dashboard") && !(typeof window !== "undefined" && window.location.search.includes("tab=attendance")) || route().current("athlete.dashboard") || route().current("parent.dashboard"),
                children: "Dashboard"
              }
            ),
            isManager && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsxs(Dropdown, { children: [
                /* @__PURE__ */ jsx(Dropdown.Trigger, { children: /* @__PURE__ */ jsxs(
                  ...
                  {
                    type: "button",
                    className: "inline-flex items-center gap-1 border-b-2 px-2 xl:px-3 pt-1 pb-0.5 text-xs xl:text-sm font-semibold leading-5 transition-all duration-150 ease-in-out focus:outline-none cursor-pointer " + (isClubActive ? "border-indigo-600 text-indigo-700 bg-indigo-50 rounded-t-lg" : "border-transparent text-gray-500 hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50/60 rounded-t-lg"),
                    children: [
                      /* @__PURE__ */ jsx("span", { children: "Club" }),
                      /* @__PURE__ */ jsx("svg", { className: "w-3 h-3 text-gray-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2.6, d: "M19 9l-7 7-7-7" }) })
                    ]
                  }
                ) }),
                /* @__PURE__ */ jsxs(Dropdown.Content, { align: "left", children: [
                  /* @__PURE__ */ jsx(Dropdown.Link, { href: route("manager.club.edit"), className: route().current("manager.club.edit") ? "bg-indigo-50 text-indigo-700 font-bold" : "", children: "Club Settings" }),
                  /* @__PURE__ */ jsx(Dropdown.Link, { href: route("manager.members.index"), className: route().current("manager.members.index") ? "bg-indigo-50 text-indigo-700 font-bold" : "", children: "Members" }),
                  /* @__PURE__ */ jsx(Dropdown.Link, { href: route("manager.coaches.index"), className: route().current("manager.coaches.index") ? "bg-indigo-50 text-indigo-700 font-bold" : "", children: "Coaches" }),
                  /* @__PURE__ */ jsx(Dropdown.Link, { href: route("manager.groups.index"), className: route().current("manager.groups.index") ? "bg-indigo-50 text-indigo-700 font-bold" : "", children: "Groups" }),
                  /* @__PURE__ */ jsx(Dropdown.Link, { href: route("manager.attendance.index"), className: route().current("manager.attendance.*") ? "bg-indigo-50 text-indigo-700 font-bold" : "", children: "Attendance" }),
                  /* @__PURE__ */ jsx(Dropdown.Link, { href: route("manager.points.setup"), className: route().current("manager.points.setup") ? "bg-indigo-50 text-indigo-700 font-bold" : "", children: "Points Setup" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs(Dropdown, { children: [
                /* @__PURE__ */ jsx(Dropdown.Trigger, { children: /* @__PURE__ */ jsxs(
                  ...
                  {
                    type: "button",
                    className: "inline-flex items-center gap-1 border-b-2 px-2 xl:px-3 pt-1 pb-0.5 text-xs xl:text-sm font-semibold leading-5 transition-all duration-150 ease-in-out focus:outline-none cursor-pointer " + (isBillingActive ? "border-indigo-600 text-indigo-700 bg-indigo-50 rounded-t-lg" : "border-transparent text-gray-500 hover:border-indigo-300 hover:text-indigo-600 hover:bg-indigo-50/60 rounded-t-lg"),
                    children: [
                ...
                /* @__PURE__ */ jsxs(Dropdown.Content, { align: "left", children: [
                  /* @__PURE__ */ jsx(Dropdown.Link, { href: route("manager.billing.index"), className: route().current("manager.billing.index") ? "bg-indigo-50 text-indigo-700 font-bold" : "", children: "Billing & Revenue" }),
                  /* @__PURE__ */ jsx(Dropdown.Link, { href: route("manager.reports.index"), className: route().current("manager.reports.index") ? "bg-indigo-50 text-indigo-700 font-bold" : "", children: "Financial Reports" })
                ] })
              ] }),
              /* @__PURE__ */ jsx(NavLink, { href: route("manager.events.index"), active: route().current("manager.events.index"), children: "Events" }),
              /* @__PURE__ */ jsx(NavLink, { href: route("leaderboard"), active: route().current("leaderboard"), children: "Leaderboard" })
            ] }),
            !isManager && !isParent && user.roles?.includes("Athlete") && /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx(NavLink, { href: route("athlete.billing"), active: route().current("athlete.billing"), children: "Billing" }),
              /* @__PURE__ */ jsx(NavLink, { href: route("leaderboard"), active: route().current("leaderboard"), children: "Leaderboard" })
            ] }),
            !isManager && !isParent && user.roles?.includes("Coach") && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(NavLink, { href: route("coach.events.index"), active: route().current("coach.events.index"), children: "Events" }),
              /* @__PURE__ */ jsx(NavLink, { href: route("coach.schedule"), active: route().current("coach.schedule"), children: "Schedule" }),
              /* @__PURE__ */ jsx(NavLink, { href: route("coach.my-team"), active: route().current("coach.my-team"), children: "My Team" }),
              /* @__PURE__ */ jsx(NavLink, { href: route("coach.dashboard") + "?tab=attendance", active: route().current("coach.dashboard") && typeof window !== "undefined" && window.location.search.includes("tab=attendance"), children: "Attendance" }),
              /* @__PURE__ */ jsx(NavLink, { href: route("leaderboard"), active: route().current("leaderboard"), children: "Leaderboard" })
            ] }),
            isParent && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(NavLink, { href: route("parent.billing"), active: route().current("parent.billing"), children: "My Billing" }),
              /* @__PURE__ */ jsx(NavLink, { href: route("leaderboard"), active: route().current("leaderboard"), children: "Leaderboard" })
            ] }),
            /* @__PURE__ */ jsxs(
              Link,
              {
                ...
                className: `relative inline-flex items-center gap-1.5 px-2 xl:px-3 py-2 rounded-lg text-xs xl:text-sm font-semibold transition-colors ${route().current("messages.*") ? "text-indigo-700 bg-indigo-50" : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"}`,
                children: [
                  "Messages",
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden lg:flex items-center gap-3 shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(
            UserAvatar,
            {
              name: user.name,
              photo: user.profile_photo,
              className: "w-8 h-8 rounded-full text-sm border border-indigo-200"
            }
          ),
          /* @__PURE__ */ jsxs(Dropdown, { children: [
            /* @__PURE__ */ jsx(Dropdown.Trigger, { children: /* @__PURE__ */ jsxs(
        ...
        /* @__PURE__ */ jsx("div", { className: "-me-2 flex items-center lg:hidden", children: /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: (showingNavigationDropdown ? "block" : "hidden") + " lg:hidden border-t border-gray-100", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-0.5 px-4 pb-4 pt-3", children: [
          ...
          isManager && /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("manager.attendance.index"), active: route().current("manager.attendance.*"), children: "Attendance" }),
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("leaderboard"), active: route().current("leaderboard"), children: "Leaderboard" })
          ] }),
          !isManager && !isParent && user.roles?.includes("Athlete") && /* @__PURE__ */ jsxs(Fragment, { children: [
            ...
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("athlete.billing"), active: route().current("athlete.billing"), children: "Billing" }),
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("leaderboard"), active: route().current("leaderboard"), children: "Leaderboard" })
          ] }),
          !isManager && !isParent && user.roles?.includes("Coach") && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("coach.events.index"), active: route().current("coach.events.index"), children: "Events" }),
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("coach.schedule"), active: route().current("coach.schedule"), children: "Schedule" }),
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("coach.my-team"), active: route().current("coach.my-team"), children: "My Team" }),
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("coach.dashboard") + "?tab=attendance", active: route().current("coach.dashboard") && typeof window !== "undefined" && window.location.search.includes("tab=attendance"), children: "Attendance" }),
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("leaderboard"), active: route().current("leaderboard"), children: "Leaderboard" })
          ] }),
          isParent && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("parent.billing"), active: route().current("parent.billing"), children: "My Billing" }),
            /* @__PURE__ */ jsx(ResponsiveNavLink, { href: route("leaderboard"), active: route().current("leaderboard"), children: "Leaderboard" })
          ] }),
          /* @__PURE__ */ jsxs(
            Link,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            /* @__PURE__ */ jsx(
              UserAvatar,
              {
                name: user.name,
                photo: user.profile_photo,
                className: "w-9 h-9 rounded-full text-sm border border-indigo-200"
              }
            ),
