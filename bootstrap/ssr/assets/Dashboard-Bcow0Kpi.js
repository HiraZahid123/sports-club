              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-5", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                    ...
                    user.club && /* @__PURE__ */ jsx("p", { className: `text-xs truncate font-medium ${cardStyle.text.includes("text-white") ? "text-white/80" : "text-gray-500"}`, children: user.club.name })
                  ] })
                ] }),
                ...
                myPosition && /* @__PURE__ */ jsxs("div", { className: "mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/20 backdrop-blur-sm border border-white/25", children: [
                  /* @__PURE__ */ jsx("span", { className: `text-[10px] font-extrabold uppercase tracking-widest ${cardStyle.text.includes("text-white") ? "text-white/70" : "text-gray-500"}`, children: "Position" }),
