...
function GroupsIndex({ groups, coaches, athletes, ageCategories, facilities }) {
  ...
  const [selectedGroupIdForExport, setSelectedGroupIdForExport] = useState("");
  ...
  const exportGroupsToCSV = () => {
    ...
    link.setAttribute("download", `groups_export_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`);
    link.style.visibility = "hidden";
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  };
  const exportGroupMembersToCSV = (groupId) => {
    ...
    const link = document.createElement("a");
    link.setAttribute("href", url);
    link.setAttribute("download", `${group.name.replace(/\s+/g, "_")}_members_export_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`);
    link.style.visibility = "hidden";
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  ...
  return /* @__PURE__ */ jsxs(
    Authenticated,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
          ...
          groups.length === 0 && !isCreating ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm py-16 text-center", children: [
            ...
            return /* @__PURE__ */ jsxs("div", { className: `bg-white rounded-2xl border shadow-sm hover:shadow-md transition-shadow flex flex-col overflow-hidden ${isEditing ? "border-amber-300 ring-2 ring-amber-200" : "border-gray-100"}`, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "px-6 py-3.5 bg-slate-50 border-t border-gray-100 flex items-center justify-between gap-3", children: [
                /* @__PURE__ */ jsxs(
                  "button",
                  {
        ...
        /* @__PURE__ */ jsx(Modal, { show: isExportOpen, onClose: () => setIsExportOpen(false), maxWidth: "md", children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-gray-900 mb-2", children: "Export Group Members" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mb-5", children: "Select a training group below to export its full athlete list as a CSV file." }),
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "", disabled: true, children: "— Select a Group —" }),
                    groups.map((g) => /* @__PURE__ */ jsxs("option", { value: g.id, children: [
                      g.name,
                      " (",
                      g.athletes_count,
                      " athletes)"
