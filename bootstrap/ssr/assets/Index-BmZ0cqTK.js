...
function AthleteBilling({ subscriptions }) {
  const { flash } = usePage().props;
  const [loadingSubId, setLoadingSubId] = useState(null);
  const paymentsList = subscriptions.reduce((acc, sub) => {
    if (sub.payments) {
  ...
  return /* @__PURE__ */ jsxs(
    Authenticated,
    {
      header: /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mt-0.5", children: "Manage your subscription plans and view your payment history" })
      ] }),
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
          ...
          flash?.error && /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 p-5 bg-rose-50 border border-rose-200 rounded-2xl shadow-sm transition-all duration-300", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "lg:col-span-3 space-y-5", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-gray-900", children: "My Subscriptions" }),
              subscriptions.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm py-12 text-center", children: [
              ...
              ] }) : subscriptions.map((sub, idx) => /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md transition-shadow", children: [
                /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-4", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-indigo-600 uppercase tracking-widest mb-1", children: "Subscription Plan" }),
                      /* @__PURE__ */ jsx("h4", { className: "text-lg font-bold text-gray-900", children: sub.plan ? sub.plan.name : sub.plan_name }),
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-end justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "font-semibold text-gray-900 text-sm mt-0.5", children: formatDate(sub.next_payment_at) })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                      ...
                      /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400 mt-1 capitalize", children: sub.billing_cycle })
                    ] })
                  ] })
                ] }),
                (sub.status === "unpaid" || sub.status === "overdue") && /* @__PURE__ */ jsx("div", { className: "px-6 py-4 bg-slate-50 border-t border-gray-100", children: /* @__PURE__ */ jsx(
                  "button",
                  {
            ...
            /* @__PURE__ */ jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "divide-y divide-gray-50", children: sortedPayments.length === 0 ? /* @__PURE__ */ jsx("div", { className: "py-8 text-center text-sm font-medium text-gray-500", children: "No payment history found." }) : sortedPayments.map((payment, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-6 py-4 hover:bg-slate-50 transition-colors", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: new Date(payment.payment_date).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsx(
                    "a",
                    {
                      ...
                      children: /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" }) })
                    }
                  )
                ] })
              ] }, i)) })
