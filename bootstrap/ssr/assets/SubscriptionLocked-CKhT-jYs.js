        ...
        /* @__PURE__ */ jsxs("div", { className: "px-8 py-7 space-y-6", children: [
          ...
          subscriptions.length > 0 && /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
            ...
            subscriptions.map((sub) => {
              ...
              return /* @__PURE__ */ jsxs("div", { className: "rounded-2xl border border-gray-100 bg-slate-50 p-4 flex items-center justify-between gap-4", children: [
                /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                  ...
                  sub.next_payment_at && /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-400 mt-1", children: [
                    "Due: ",
                    /* @__PURE__ */ jsx("span", { className: "font-semibold text-gray-600", children: sub.next_payment_at })
                  ] })
                ] }),
