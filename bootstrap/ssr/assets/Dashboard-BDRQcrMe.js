...
import { A as Authenticated } from "./AuthenticatedLayout-8yb_hiGI.js";
import { usePage, Head, Link } from "@inertiajs/react";
import { a as getBeltCardGradient, b as getBeltStyle, c as getNextBelt } from "./beltHelpers-6FZX55wB.js";
import { g as getDateForDayOfWeek, f as formatDate } from "./dateHelpers-pzAD51Td.js";
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: `relative bg-gradient-to-br ${cardStyle.bg} rounded-2xl p-8 overflow-hidden`, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-5", children: [
                  /* @__PURE__ */ jsx("div", { className: `w-16 h-16 rounded-2xl overflow-hidden border shadow-inner shrink-0 ${cardStyle.text.includes("text-white") ? "bg-white/20 border-white/30" : "bg-black/10 border-black/15"} backdrop-blur-sm flex items-center justify-center`, children: user.profile_photo ? /* @__PURE__ */ jsx(
                    "img",
                    {
                  ...
                  ) : /* @__PURE__ */ jsx("div", { className: `w-full h-full flex items-center justify-center font-black text-2xl ${cardStyle.text.includes("text-white") ? "text-white" : "text-gray-700"}`, children: user.name.charAt(0).toUpperCase() }) }),
                  /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                    /* @__PURE__ */ jsx("h4", { className: `text-base font-bold truncate leading-snug ${cardStyle.text.includes("text-white") ? "text-white" : "text-gray-900"}`, children: user.name }),
                    user.club && /* @__PURE__ */ jsx("p", { className: `text-xs truncate font-medium ${cardStyle.text.includes("text-white") ? "text-white/70" : "text-gray-500"}`, children: user.club.name }),
                    /* @__PURE__ */ jsx("span", { className: `inline-flex items-center gap-1 mt-1.5 text-[10px] font-extrabold uppercase tracking-widest px-2.5 py-0.5 rounded-lg ${cardStyle.text.includes("text-white") ? "bg-white/20 text-white border border-white/25" : "bg-black/10 text-gray-700 border border-black/10"}`, children: "🥋 Athlete" })
                  ] })
                ] }),
                user.titles && Array.isArray(user.titles) && user.titles.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
                  /* @__PURE__ */ jsx("p", { className: `text-[10px] font-extrabold uppercase tracking-widest mb-2 ${cardStyle.text.includes("text-white") ? "text-white/50" : "text-gray-400"}`, children: "Position" }),
                  /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1.5", children: user.titles.map((title, i) => /* @__PURE__ */ jsx(
                    "span",
                    {
                      className: `inline-flex items-center text-xs font-bold px-3 py-1 rounded-xl backdrop-blur-sm border ${cardStyle.text.includes("text-white") ? "bg-white/15 border-white/25 text-white" : "bg-white/60 border-gray-200 text-gray-800"}`,
                      children: title
                    },
                    i
                  )) })
                ...
                /* @__PURE__ */ jsxs("p", { className: `text-xs mb-0 ${cardStyle.text.includes("text-white") ? "text-white/60" : "text-gray-500"}`, children: [
                  "Next: ",
                ...
                myPosition && /* @__PURE__ */ jsxs("div", { className: "mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/20 backdrop-blur-sm border border-white/25", children: [
                  /* @__PURE__ */ jsx("span", { className: `text-[10px] font-extrabold uppercase tracking-widest ${cardStyle.text.includes("text-white") ? "text-white/70" : "text-gray-500"}`, children: "Rank" }),
                  /* @__PURE__ */ jsxs("span", { className: `text-sm font-black ${cardStyle.text.includes("text-white") ? "text-white" : "text-gray-900"}`, children: [
                    "#",
                    myPosition
                  ] }),
                  /* @__PURE__ */ jsx("span", { className: `text-[10px] font-medium ${cardStyle.text.includes("text-white") ? "text-white/60" : "text-gray-500"}`, children: "in club" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm p-6", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: progressStats.map((stat, i) => /* @__PURE__ */ jsxs("div", { className: `border rounded-xl p-4 text-center ${stat.color.split(" ").slice(0, 2).join(" ")}`, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "divide-y divide-gray-50", children: upcomingSchedules.length > 0 ? upcomingSchedules.map((slot) => {
                ...
                return /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-4 px-6 py-4 hover:bg-slate-50 transition-colors border-l-4 ${dayColor}`, children: [
                  /* @__PURE__ */ jsxs("div", { className: "text-center w-16 shrink-0 flex flex-col items-center justify-center", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-xs font-extrabold uppercase tracking-wide text-gray-400", children: slot.day_of_week.substring(0, 3) }),
                    /* @__PURE__ */ jsx("p", { className: "text-xl font-black text-gray-800 leading-none mt-1", children: dateNum })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500", children: [
                      coaches,
                      " • ",
                      slot.is_event ? "All Day" : `${slot.start_time.substring(0, 5)} - ${slot.end_time.substring(0, 5)}`
                    ] })
                  ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-5", children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-indigo-50 to-pink-50 rounded-2xl border border-indigo-100 p-5 shadow-sm", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-xl", children: "🎂" }),
                  /* @__PURE__ */ jsx("p", { className: "text-sm font-black text-indigo-900", children: "Today's Birthdays" })
                ] }),
                birthdays && birthdays.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-3", children: birthdays.map((b) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-white/60 backdrop-blur-sm rounded-xl p-3 border border-indigo-100/50", children: [
                  /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-gray-800", children: b.name }),
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400 font-semibold mt-0.5", children: b.groups.join(", ") })
                  ] }),
                  b.age !== null && /* @__PURE__ */ jsxs("span", { className: "text-[10px] font-black text-indigo-700 bg-indigo-50 border border-indigo-100 rounded-lg px-2 py-0.5 shrink-0", children: [
                    "Turns ",
                    b.age,
                    " 🎉"
                  ] })
                ] }, b.id)) }) : /* @__PURE__ */ jsx("p", { className: "text-xs text-indigo-700/80 italic text-left", children: "No birthdays in your groups today." })
              ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden", children: [
            /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 border-b border-gray-50 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h3", { className: "text-base font-bold text-gray-900", children: "Points History Log" }),
                /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mt-0.5", children: "Detailed timeline of points earned or reset archives" })
              ] }),
              /* @__PURE__ */ jsx("span", { className: "text-2xl", children: "⏳" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "p-6", children: pointHistory.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center py-10 text-gray-400 italic text-sm", children: "No points history logged yet. Attend classes or events to earn points!" }) : /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse text-xs", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-gray-100 text-gray-400 uppercase tracking-wider font-extrabold", children: [
                /* @__PURE__ */ jsx("th", { className: "py-3 px-4", children: "Date" }),
                /* @__PURE__ */ jsx("th", { className: "py-3 px-4", children: "Type" }),
                /* @__PURE__ */ jsx("th", { className: "py-3 px-4", children: "Description / Comment" }),
                /* @__PURE__ */ jsx("th", { className: "py-3 px-4 text-right", children: "Points" })
              ] }) }),
              /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: pointHistory.map((log, index) => {
                ...
                const badgeStyle = {
                  ...
                  adjustment: isNeg ? "bg-rose-50 text-rose-700 border-rose-100" : "bg-violet-50 text-violet-700 border-violet-100"
                }[log.type];
                const label = {
                ...
                const ptsColor = isReset ? "text-amber-600" : isAdjustment && isNeg ? "text-rose-600" : isAdjustment ? "text-violet-600" : "text-indigo-600";
                const ptsPrefix = isReset ? "" : isNeg ? "−" : "+";
                const ptsDisplay = `${ptsPrefix}${Math.abs(log.points)} pts`;
                return /* @__PURE__ */ jsxs("tr", { className: `hover:bg-slate-50/50 transition-colors ${isAdjustment && isNeg ? "bg-rose-50/30" : ""}`, children: [
                  /* @__PURE__ */ jsx("td", { className: "py-3.5 px-4 font-medium text-gray-500 font-mono", children: formatDate(log.date) }),
                  /* @__PURE__ */ jsx("td", { className: "py-3.5 px-4", children: /* @__PURE__ */ jsx("span", { className: `inline-flex items-center border rounded-lg px-2 py-0.5 text-[10px] font-bold ${badgeStyle}`, children: label }) }),
                  /* @__PURE__ */ jsx("td", { className: "py-3.5 px-4 text-gray-700 font-semibold", children: isAdjustment ? /* @__PURE__ */ jsxs("span", { className: `flex items-start gap-1 text-[11px] italic font-medium ${isNeg ? "text-rose-600" : "text-violet-600"}`, children: [
                    /* @__PURE__ */ jsx("span", { children: "💬" }),
                    /* @__PURE__ */ jsx("span", { children: log.description })
                  ] }) : /* @__PURE__ */ jsx("span", { children: log.description }) }),
                  /* @__PURE__ */ jsx("td", { className: `py-3.5 px-4 text-right font-black text-sm ${ptsColor}`, children: ptsDisplay })
                ] }, index);
              }) })
            ] }) }) })
          ] })
