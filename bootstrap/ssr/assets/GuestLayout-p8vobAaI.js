...
const mlSportsLogo = "/build/assets/ml-sports-transparent-C0uhSQAf.png";
function Guest({ children }) {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex", children: [
    /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex lg:w-5/12 bg-gradient-to-br from-indigo-600 via-indigo-700 to-blue-800 flex-col justify-between p-12 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx(Link, { href: "/", className: "relative flex items-center bg-white rounded-xl px-4 py-2 shadow-sm w-fit", children: /* @__PURE__ */ jsx("img", { src: mlSportsLogo, alt: "ML Sports", className: "h-14 w-auto object-contain" }) }),
      ...
      /* @__PURE__ */ jsx("p", { className: "relative text-indigo-400 text-xs", children: "© 2026 ML Sports Technologies. All rights reserved." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col items-center justify-center px-6 py-12 bg-white", children: [
      /* @__PURE__ */ jsx("div", { className: "lg:hidden flex items-center mb-10", children: /* @__PURE__ */ jsx(Link, { href: "/", children: /* @__PURE__ */ jsx("img", { src: mlSportsLogo, alt: "ML Sports", className: "h-14 w-auto object-contain" }) }) }),
