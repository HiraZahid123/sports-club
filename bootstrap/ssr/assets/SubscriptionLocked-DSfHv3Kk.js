...
function SubscriptionLocked({ subscriptions, club, userRole, isProfileInactive }) {
  const isParent = userRole === "Parent";
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Your profile is not active" }),
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 py-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "w-full max-w-lg bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-red-500 to-rose-600 px-8 py-8 text-center", children: [
          ...
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-black text-white mb-1", children: "Your profile is not active" }),
          /* @__PURE__ */ jsx("p", { className: "text-red-100 text-sm", children: isProfileInactive ? "Your profile has been deactivated by the club manager." : isParent ? "One or more of your children's memberships require payment." : "Your membership payment is overdue or unpaid." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "px-8 py-7 space-y-6", children: [
          /* @__PURE__ */ jsxs("p", { className: "text-gray-600 text-sm leading-relaxed text-center", children: [
            "Access to your ",
            isParent ? "children's" : "",
            " profile and club features has been temporarily suspended. Please contact your club manager to resolve this."
          ] }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 pt-1", children: [
            ...
            ) : !isProfileInactive && userRole === "Athlete" && /* @__PURE__ */ jsx(
              Link,
              {
                href: route("athlete.billing"),
                className: "w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold rounded-xl text-center transition-all shadow-sm shadow-indigo-200",
                children: "View Billing & Payments"
              }
            ),
            /* @__PURE__ */ jsx(
              Link,
