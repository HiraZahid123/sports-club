...
import { A as Authenticated, U as UserAvatar } from "./AuthenticatedLayout-CfnCls_-.js";
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-5", children: [
                  /* @__PURE__ */ jsx(
                    UserAvatar,
                    {
                      ...
                      className: `w-16 h-16 rounded-2xl border shadow-inner backdrop-blur-sm text-2xl ${cardStyle.text.includes("text-white") ? "border-white/30" : "border-black/15"}`,
                      fallbackClassName: cardStyle.text.includes("text-white") ? "bg-white/20 text-white" : "bg-black/10 text-gray-700"
                    }
                  ),
