      ...
      children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                        ...
                        !coach.is_active && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-medium bg-red-100 text-red-800", children: "Deactivated" })
                      ] }),
                      ...
                      coach.titles && coach.titles.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1 mt-1", children: coach.titles.map((t) => /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[9px] font-bold bg-violet-50 text-violet-600 border border-violet-100", children: [
                        "🏅 ",
                        t
                      ] }, t)) })
                    ] })
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
                    ...
                    /* @__PURE__ */ jsx(
                      Link,
                      {
                        ...
                        method: "post",
                        as: "button",
                        className: `px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors ${!coach.is_active ? "text-emerald-600 bg-emerald-50 hover:bg-emerald-100" : "text-rose-600 bg-rose-50 hover:bg-rose-100"}`,
                        children: !coach.is_active ? "Activate" : "Deactivate"
                      }
                    )
                  ] }) })
                ] }, coach.id);
          ...
          /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "flex flex-col flex-1 overflow-hidden", children: [
            /* @__PURE__ */ jsxs("div", { className: "overflow-y-auto flex-1 p-6 space-y-5", children: [
              activeTab === "info" && /* @__PURE__ */ jsxs(Fragment, { children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("label", { className: labelClass, children: "Titles & Honours" }),
                  data.titles.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 mb-2", children: data.titles.map((t) => /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-bold bg-violet-50 text-violet-700 border border-violet-200", children: [
                    "🏅 ",
                    t,
                    /* @__PURE__ */ jsx("button", { type: "button", onClick: () => removeCoachTitle(t), className: "text-violet-400 hover:text-violet-700 ml-0.5 leading-none", children: "×" })
                  ] }, t)) }),
                  /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex-1 relative", children: [
                      ...
                      /* @__PURE__ */ jsx("datalist", { id: "coach-title-suggestions", children: TITLE_SUGGESTIONS.map((s) => /* @__PURE__ */ jsx("option", { value: s }, s)) })
                    ] }),
                    /* @__PURE__ */ jsx(
                      "button",
                      {
        ...
        showInviteCoach && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-amber-50 to-orange-50 px-6 py-4 border-b border-amber-100 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-amber-900", children: "Invite Coach" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-amber-600 mt-0.5", children: "Send a registration link to a new coach" })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxs("form", { onSubmit: submitInvite, className: "p-6 space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5", children: "Email Address" }),
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "email",
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { className: "block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5", children: "Salary / Payout Option" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  className: "w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-900 focus:border-amber-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500/20 transition-all",
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "manual", children: "Fixed / Manual Payout" }),
                    /* @__PURE__ */ jsx("option", { value: "athlete", children: "Per Active Athlete" }),
                    /* @__PURE__ */ jsx("option", { value: "hourly", children: "Hourly Rate" })
                  ]
                }
              )
            ] }),
