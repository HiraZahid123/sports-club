          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "p-6", children: pointHistory.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center py-10 text-gray-400 italic text-sm", children: "No points history logged yet. Attend classes or events to earn points!" }) : /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse text-xs", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-gray-100 text-gray-400 uppercase tracking-wider font-extrabold", children: [
                ...
                /* @__PURE__ */ jsx("th", { className: "py-3 px-4", children: "Description" }),
              ...
              /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: pointHistory.map((log, index) => {
                ...
                return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50/50 transition-colors", children: [
                  ...
                  /* @__PURE__ */ jsx("td", { className: "py-3.5 px-4 text-gray-700 font-semibold", children: log.description }),
                  /* @__PURE__ */ jsx("td", { className: `py-3.5 px-4 text-right font-black text-sm ${log.type === "reset" ? "text-amber-600" : "text-indigo-600"}`, children: log.type === "reset" ? `${log.points} pts` : `+${log.points} pts` })
                ] }, index);
              }) })
            ] }) }) })
          ] })
