...
function MembersIndex({ members }) {
  ...
  const exportMembersToCSV = () => {
    ...
    link.setAttribute("download", `members_export_${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`);
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
          isFormOpen && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-indigo-100 shadow-sm overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "p-6 space-y-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-gray-400 uppercase tracking-widest mb-3", children: "Titles & Honours" }),
                data.titles.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 mb-3", children: data.titles.map((t) => /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-bold bg-violet-50 text-violet-700 border border-violet-200", children: [
                  "🏅 ",
                  t,
                  /* @__PURE__ */ jsx(
                    "button",
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 relative", children: [
                    ...
                    /* @__PURE__ */ jsx("datalist", { id: "title-suggestions", children: TITLE_SUGGESTIONS.map((s) => /* @__PURE__ */ jsx("option", { value: s }, s)) })
                  ] }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                ...
                /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-gray-400 mt-1.5", children: [
                  "Suggestions: ",
                  TITLE_SUGGESTIONS.slice(0, 5).join(", "),
                  "…"
                ] })
              ] }),
          ...
          /* @__PURE__ */ jsx("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden", children: /* @__PURE__ */ jsxs("div", { className: "overflow-x-auto", children: [
            /* @__PURE__ */ jsxs("table", { className: "w-full", children: [
              /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-slate-50 border-b border-gray-100", children: [
                ...
                /* @__PURE__ */ jsx("th", { className: "px-6 py-3.5 text-left text-xs font-bold text-gray-500 uppercase tracking-wide", children: "Role & Titles" }),
              ...
              /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: members.map((member) => {
                return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50/60 transition-colors", children: [
                  /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsx(
                      UserAvatar,
                      {
                        ...
                        className: "w-9 h-9 rounded-full text-sm border border-indigo-100",
                    ...
                    /* @__PURE__ */ jsxs("div", { children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                        ...
                        !member.is_active && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-medium bg-red-100 text-red-800", children: "Deactivated" })
                      ] }),
                  ...
                  /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
                    ...
                    member.titles && member.titles.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-1 mt-1.5", children: member.titles.map((t) => /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[9px] font-bold bg-violet-50 text-violet-600 border border-violet-100", children: [
                      "🏅 ",
                      t
                    ] }, t)) })
                  ] }),
                  ...
                  /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-end gap-2", children: [
                    ...
                    /* @__PURE__ */ jsx(
                      Link,
                      {
                        ...
                        method: "post",
                        as: "button",
                        className: `px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors ${!member.is_active ? "text-emerald-600 bg-emerald-50 hover:bg-emerald-100" : "text-rose-600 bg-rose-50 hover:bg-rose-100"}`,
                        children: !member.is_active ? "Activate" : "Deactivate"
                      }
                    ),
                    /* @__PURE__ */ jsx(
                      Link,
