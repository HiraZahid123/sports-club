        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: schedules.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-6", children: DAYS.map((day) => {
            ...
            return /* @__PURE__ */ jsxs("div", { className: "border border-gray-100 rounded-2xl overflow-hidden shadow-sm", children: [
              /* @__PURE__ */ jsxs("div", { className: "bg-slate-50 px-5 py-3 border-b border-gray-100 flex items-center justify-between", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-indigo-900", children: day }),
                /* @__PURE__ */ jsx("span", { className: "text-sm font-black text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-lg border border-indigo-100", children: dateNum })
              ] }),
                ...
                return /* @__PURE__ */ jsxs("div", { className: "p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 hover:bg-slate-50/55 transition-all", children: [
                  /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
                      slot.is_event ? /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-amber-50 text-amber-700 rounded-xl text-xs font-extrabold border border-amber-100", children: "Event" }) : /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-indigo-50 text-indigo-700 rounded-xl text-xs font-extrabold border border-indigo-100", children: slot.group.name }),
                      /* @__PURE__ */ jsx("span", { className: "text-sm font-black text-gray-700", children: slot.is_event ? "All Day" : `${fmtTime(slot.start_time)} - ${fmtTime(slot.end_time)}` })
                    ] }),
                    slot.is_event && /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-900", children: slot.event_name }),
