...
function PointAdjustPanel({ athlete }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "border-t border-gray-100 pt-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3 p-2.5 bg-indigo-50 rounded-xl border border-indigo-100", children: [
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-3", children: [
      /* @__PURE__ */ jsx("div", { className: "flex gap-2", children: /* @__PURE__ */ jsxs("div", { className: "flex-1 relative", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            ...
            className: `w-full rounded-xl border px-3 py-2 text-sm font-bold text-center transition-all focus:outline-none focus:ring-2 ${isNegative ? "border-rose-300 bg-rose-50 text-rose-700 focus:ring-rose-300/30 focus:border-rose-400" : isPositive ? "border-emerald-300 bg-emerald-50 text-emerald-700 focus:ring-emerald-300/30 focus:border-emerald-400" : "border-gray-200 bg-gray-50 text-gray-700 focus:ring-indigo-300/30 focus:border-indigo-400"}`
          }
        ),
        data.points !== "" && /* @__PURE__ */ jsxs("span", { className: `absolute right-2.5 top-1/2 -translate-y-1/2 text-[10px] font-extrabold ${isNegative ? "text-rose-400" : "text-emerald-400"}`, children: [
          isNegative ? "−" : "+",
          "pts"
        ] })
      ] }) }),
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          className: `w-full py-2 text-white text-xs font-bold rounded-xl transition-all disabled:opacity-50 shadow-sm ${isNegative ? "bg-rose-500 hover:bg-rose-600" : "bg-emerald-600 hover:bg-emerald-700"}`,
    ...
    /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold text-sm shrink-0 overflow-hidden", children: athlete.profile_photo ? /* @__PURE__ */ jsx(
            "img",
            {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative bg-gradient-to-br from-indigo-600 via-blue-700 to-indigo-800 rounded-2xl p-8 overflow-hidden text-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
        /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-2xl overflow-hidden border-2 border-white/30 bg-white/20 backdrop-blur-sm flex items-center justify-center shrink-0 shadow-inner", children: user.profile_photo ? /* @__PURE__ */ jsx(
          "img",
          {
        ...
        ) : /* @__PURE__ */ jsx("div", { className: "w-full h-full flex items-center justify-center font-black text-2xl text-white", children: user.name.charAt(0).toUpperCase() }) }),
      ...
      /* @__PURE__ */ jsx("p", { className: "text-[11px] font-extrabold uppercase tracking-widest mb-2 text-white/60", children: "Position" }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3 mb-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-white/15 backdrop-blur-sm border border-white/20 rounded-xl px-4 py-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-xl", children: "🎽" }),
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-black text-white tracking-wide", children: "COACH" })
      ] }) }),
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "md:col-span-2 grid grid-cols-2 gap-4", children: statCards.map((card) => {
              ...
              const cardProps = card.id === null ? { href: route("coach.schedule") } : { onClick: () => setActiveSection(activeSection === card.id ? null : card.id) };
              return /* @__PURE__ */ jsxs(
                CardTag,
                {
                  ...cardProps,
                  className: `group bg-white rounded-2xl border shadow-sm p-5 text-left cursor-pointer transition-all hover:shadow-md hover:-translate-y-0.5 ${isActive ? `${card.border} ring-2 ${card.ring}/40 shadow-md -translate-y-0.5` : `${card.border}`}`,
                  children: [
