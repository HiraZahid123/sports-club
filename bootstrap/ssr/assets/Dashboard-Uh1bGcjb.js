      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
          ...
          activeSection === "overview" && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col", children: [
              /* @__PURE__ */ jsxs("div", { className: "border-b border-gray-50 pb-3 mb-4 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-gray-900", children: "Quick Actions" }),
                  /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500 mt-0.5", children: "Fast navigation options" })
                ] }),
                /* @__PURE__ */ jsx("div", { className: "w-8 h-8 bg-indigo-50 rounded-xl flex items-center justify-center text-sm", children: "⚡" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
                [
                  { label: "Mark Attendance", section: "attendance", icon: "📝", sub: "Log athlete attendance", color: "bg-indigo-50 border-indigo-100 hover:bg-indigo-100" },
                  { label: "View Athlete List", section: "athletes", icon: "🥋", sub: "Manage athlete skills", color: "bg-emerald-50 border-emerald-100 hover:bg-emerald-100" },
                  { label: "Manage Groups", section: "groups", icon: "🏆", sub: "View group schedules", color: "bg-purple-50 border-purple-100 hover:bg-purple-100" }
          ...
          activeSection === "groups" && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-6", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "lg:col-span-3 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden", children: selectedGroup ? /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 border-b border-gray-50 bg-slate-50/50", children: [
                ...
                !selectedGroup.schedules || selectedGroup.schedules.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 italic", children: "No schedule set for this group." }) : /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: selectedGroup.schedules.map((s, i) => {
          ...
          activeSection === "attendance" && /* @__PURE__ */ jsx(CoachAttendanceSection, { groups })
        ] }) })
      ]
    }
  );
}
function CoachAttendanceSection({ groups }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden", children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-indigo-50 to-blue-50 px-6 py-4 border-b border-indigo-100 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-indigo-900", children: "Mark Training Attendance" }),
        /* @__PURE__ */ jsx("p", { className: "text-xs text-indigo-600 mt-0.5", children: "Select a group and log athlete attendance and point rewards" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "w-9 h-9 bg-indigo-100 rounded-xl flex items-center justify-center text-lg", children: "📝" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2", children: "Training Group" }),
          /* @__PURE__ */ jsx(
            "select",
            {
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2", children: "Attendance Date" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "date",
      ...
      loading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-20 text-center", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Loading group athletes list..." })
      ] }) : /* @__PURE__ */ jsxs("form", { onSubmit: submitAttendance, className: "space-y-4", children: [
        attendanceList.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center py-10 text-gray-400 italic text-sm border-2 border-dashed border-gray-100 rounded-xl", children: "No athletes found in this group." }) : /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-xl border border-gray-100", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-100 text-sm text-left", children: [
          /* @__PURE__ */ jsx("thead", { className: "bg-slate-50 text-[10px] font-bold text-gray-400 uppercase tracking-wider", children: /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3", children: "Athlete" }),
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-center", children: "Status" }),
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-center", children: "Base Points" }),
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-center", children: "Extra Points" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50 bg-white", children: attendanceList.map((row) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50/50 transition-colors", children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-center", children: /* @__PURE__ */ jsxs("div", { className: "inline-flex rounded-xl p-1 bg-slate-100 border border-slate-200/50", children: [
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  className: `px-3 py-1 text-xs font-bold rounded-lg transition-all ${row.status === "present" ? "bg-emerald-600 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"}`,
                  children: "Present"
                }
              ),
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  className: `px-3 py-1 text-xs font-bold rounded-lg transition-all ${row.status === "absent" ? "bg-rose-600 text-white shadow-sm" : "text-gray-500 hover:text-gray-700"}`,
                  children: "Absent"
                }
              )
            ] }) }),
        ...
        attendanceList.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex justify-end pt-3", children: /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: submitting ? "Saving..." : "Save Attendance Logs"
          }
        ) })
      ] })
    ] })
